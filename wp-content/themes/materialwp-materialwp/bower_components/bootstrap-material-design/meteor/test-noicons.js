...
var packageName;  // there seems to be no official way of finding out the name of the very package we're testing - https://stackoverflow.com/questions/27180709/in-a-tinytest-test-file-how-do-i-get-the-name-of-the-package
...
Tinytest.addAsync('Visual check - Material Design', function (test, done) {
  ...
  HTTP.get('https://rawgit.com/FezVrasta/bootstrap-material-design/master/bootstrap-elements.html', function callback(error, result) {
    if (error) {
