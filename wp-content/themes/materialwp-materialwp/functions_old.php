...
function az()
{
  ...
  wp_enqueue_script('custom-script-query', get_stylesheet_directory_uri() . '/custom_script_jquery.js', array('jquery'));
}
      ...
      <div class="realizacja-col">
        <div class="realizacja__inner">
          <div class="equ_medical_title">
            <h2 class="font-blue raleway center-text"><strong><a class="font-bold" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></strong></h2>
          </div>
          <a href="<?php the_permalink(); ?>">
            <div class="equ_medical_img" style="background: url(<?php the_post_thumbnail_url(); ?>)no-repeat; background-size: cover;background-position: center">
              ...
              <a href="<?php the_permalink(); ?>">
                <div class="equ_medical_info payPig">
                  <div class="c100 p<?php echo get_post_meta(get_the_ID(), 'percentMedicialEquipment', TRUE); ?> green">
                    <?php if (get_post_meta(get_the_ID(), 'field_id', TRUE)) { ?>
                      <a href="<?php the_permalink(); ?>"><img id="image-check" src="<?php echo esc_url(site_url('/')); ?>wp-content/uploads/2017/10/icon.png"></a>
                    <?php } else { ?>
                  ...
                  <a href="<?php the_permalink(); ?>">
                    ...
                    <p class="aim font-blue raleway center-text size-two-new font-bold customSupport" style="font-size: 1.4em;">I POMÓŻ TERAZ!</p>
                  </a>
                </div>
              </a>
            <?php } else { ?>
          ...
          <?php if (get_post_meta(get_the_ID(), 'field_id', TRUE)) { ?>
            <a href="<?php the_permalink(); ?>">
              <div class="equ_medical_info payPig">
                ...
                <p class="aim font-blue raleway center-text size-two-new font-bold customSupport" style="font-size: 1.4em;">Support</p>
              </div>
            </a>
          <?php } else { ?>
            <a href="<?php the_permalink(); ?>">
    ...
    ?>
      <div class="realizacja-col">
        <div class="realizacja__inner">
          ...
          <a href="<?php the_permalink(); ?>">
            <div class="equ_medical_img finished_info" style="background: url(<?php the_post_thumbnail_url(); ?>)no-repeat; background-size: cover;background-position: center">
              <!-- <?php the_post_thumbnail(array(1024, 512), array('class' => 'img-responsive')); ?>  -->
            </div>
            <div class="equ_medical_info">
              ...
              <p class="aim font-blue raleway center-text size-two font-bold aim-price">
                <?php echo get_post_meta(get_the_ID(), 'priceMedicalEquipment', TRUE); ?> <span class="carousel-pln">zł</span></p>
            </div>
          </a>
    ...
    ?>
      ...
      <div class="realizacja-col">
        <div class="realizacja__inner">
          ...
          <a href="<?php the_permalink(); ?>">
            <div class="equ_medical_img current_info" style="background: url(<?php the_post_thumbnail_url(); ?>)no-repeat; background-size: cover;background-position: center">
              <!-- <?php the_post_thumbnail(array(1024, 512), array('class' => 'img-responsive')); ?>  -->
            </div>
  ...
  ?>
    <div class="col-xs-12 col-sm-6 col-md-4 realizacja-col payDonateGrid">
      <div class="payDonateGrid<?php echo $numberId; ?>">
        ...
        <a href="<?php the_permalink(); ?>">
          <div class="equ_medical_img current_info payGridImage" test-background="<?php the_post_thumbnail_url(); ?>" style="background-image: url(<?php the_post_thumbnail_url(); ?>);background-repeat: no-repeat; background-size: cover;background-position: center">
            <!-- <?php the_post_thumbnail(array(1024, 512), array('class' => 'img-responsive')); ?>  -->
          </div>
        </a>
        <?php if (get_post_meta(get_the_ID(), 'field_id', TRUE)) { ?>
          <div class="equ_medical_info payPig">
            ...
            <p class="aim font-blue raleway center-text size-two-new font-bold customSupport" style="font-size: 1.3em;">Support</p>
          </div>
        <?php } else { ?>
          <div class="equ_medical_info">
            <div class="c100 p<?php echo get_post_meta(get_the_ID(), 'percentMedicialEquipment', TRUE); ?> green">
...
function categoryShortcodePay()
{
  echo payDonateGrid();
}
add_shortcode('payDonateGrid', 'categoryShortcodePay');

//Polski donate shortcode
function payDonateGridPl()
{
  $args = array(
    'post_type' => 'donate',
    'tax_query' => array(
            ...
            <a href="<?php the_permalink(); ?>">
              <div class="equ_medical_info payPig">
                ...
                <a href="<?php the_permalink(); ?>">
                  ...
                  <p class="aim font-blue raleway center-text size-two-new font-bold customSupport" style="font-size: 1.3em;">I POMÓŻ TERAZ!</p>
                </a>
              </div>
            </a>
          <?php } else { ?>
...
function categoryShortcodePayPl()
{
  echo payDonateGridPl();
}
add_shortcode('payDonateGridPl', 'categoryShortcodePayPl');
...
?>
  ...
  <div class="box-for-transfer">
    ...
    <h4 style="margin-bottom:0;" class="raleway font-blue center-text font-bold text-upper"><span style="font-weight: 300 !important;">PLN: </span>pl 66 1030 1508 0000 0005 0039 8019</h4>
    <!-- <p class="center-text font-blue raleway">US$ accounts:</p> -->
    <h4 style="margin-bottom:0;" class="raleway font-blue center-text font-bold text-upper"><span style="font-weight: 300 !important;">USD: </span>pl 22 1030 1508 0000 0005 0039 8035</h4>
    <p style="margin-top:15px;" class="raleway center-text font-blue">SWIFT-Code (BIC): CITIPLPX</p>
    <h3 id="tradition_transfer_title" class="raleway center-text font-blue" style="text-transform: initial !important;"></h3>
  </div>
  <div class="form_przelewy24">
    <form method="post" action="https://secure.przelewy24.pl/trnDirect">
      ...
      <?php
      $error = false;
      $returnUrl = "http://www.fundacjaprzyjaciol.org/en/thank-you/";
      $statusUrl = "http://www.fundacjaprzyjaciol.org/nowa/en/become-a-friend/";
      $amount = 1 * 100;
      $currency = "PLN";
      ...
      <input id="p24_description" type="hidden" style="width:250px" name="p24_description" value="Wsparcie / <?php echo $orderId; ?>" />
      ...
      <div class="information-under">
        <p>Let's stay in touch! Keep up-to date with the latest news and campaigns of the <span>Friends of Children's Hospitals in Warsaw</span> straight to your inbox.</p>
      </div>
      <input id="p24_client_custom" type="text" placeholder="Name and Last name" name="p24_client_custom" value="" class="przelewy_custom_fields" />
      <input id="p24_email_custom" type="text" placeholder="E-mail" name="p24_email_custom" value="" class="przelewy_custom_fields" />
      <div style="margin-top: 30px;">
        <input type="checkbox" id="subscribeNews" name="przelewy_checkbox" required />
        <span id="labelCustomBecome" for="subscribeNews"> I agree to the processing of my personal data for the marketing needs by the “Friends of Children’s Hospitals in Warsaw” foundation (“Foundation”) …</span>
      </div>
      <div class="more_info_przelewy">
        <span>[Show more...]</span>
      </div>
      <div class="przelewy_more_hide_information">
        <p>In accordance with the act of 29 August 1997 on Personal Data Protection (Journal of Laws No. 133, item 883) and to receive from the Foundation marketing information by electronic means in accordance with the Act of 18 July 2002 (Journal of Laws No. 144, item 1204, as amended) on the provision of services by electronic means. According to Art. 13 sec. 1 and par. 2 of the General Data Protection Regulation of April 27 2016, Foundation with its registered office in Warsaw ul. Grzybowska 5a, 00-132 Warsaw, as the Personal Data Administrator, inform you that:
          <ul style="list-style: circle;">
            <li class="list_custom_1">The data is voluntary;</li>
            <li class="list_custom_2">You have the right to access and rectify your data, erasure of Your personal data, restrict processing or object to such processing, transfer data, revoke consent at any time without affecting the legality of processing;</li>
            <li class="list_custom_3">Data may be made available by the Foundation to entities authorized to obtain information under applicable law;</li>
            <li class="list_custom_4">The data will be processed on the basis of art. 6 sec. (1) (a) and in line with the general data protection regulation;</li>
            <li class="list_custom_5">Personal data will be kept for a period necessary for completion of the Foundation's purposes;</li>
            <li class="list_custom_6">You have the right to file a complaint with GIODO when you believe that the processing of your personal data is contrary to the provisions of the General Data Protection Regulation of 27 April 2016.</li>
          </ul>
      </div>
  ...
  <div class="paypal-information">
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
      ...
      <input id="pp_client_custom" type="text" placeholder="Name and Last name" name="pp_client_custom" value="" class="przelewy_custom_fields" />
      <input id="pp_email_custom" type="text" placeholder="E-mail" name="pp_email_custom" value="" class="przelewy_custom_fields" />
      <div style="margin-top: 30px;">
        <input type="checkbox" id="subscribeNews" name="przelewy_checkbox" required />
        <span id="labelCustomBecomePay" for="subscribeNews"> I agree to the processing of my personal data for the marketing needs by the “Friends of Children’s Hospitals in Warsaw” foundation (“Foundation”) …</span>
      </div>
